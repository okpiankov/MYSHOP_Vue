...
<template>
  <div
    class="flex flex-row h-36 max-w-[500px] gap-1 border border-white border-solid rounded-3xl bg-red-300 text-lg leading-5 s:h-[170px] s:max-w-[310px] s:text-[16px] "
  >
